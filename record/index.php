...
<head>
	...
	<title>Shleby. | <?php echo $news["title"] ?></title>
	<link rel="stylesheet" type="text/css" href="../styles/news.css">


	<meta name="title" content="Shleby. | <?php echo $news["title"] ?>">
	<meta property="og:title" content="Shleby. | <?php echo $news["title"] ?>">
	<meta property="twitter:title" content="Shleby. | <?php echo $news["title"] ?>">

	<meta name="description" content="<?php echo $news["message"] ?>">
	<meta property="og:description" content="<?php echo $news["message"] ?>">
	<meta property="twitter:description" content="<?php echo $news["message"] ?>">
...
<body>
	...
	<div class="content">
		...
		<div class="author-and-date"><?php echo $news["author"] . " | " . $news["date"]; ?></div>
